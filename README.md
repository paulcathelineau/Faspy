...
| Set | Sections | Use |
|---|---:|---|
| **Annotated analysis set** | 148 | Manual bundle annotations used for the final analysis described in the manuscript. |
| **Production set** | 433 | Unannotated sections quantified with the final pipeline. |

> **Before release:** the archived cross-validation results currently stored in the repository were generated on an earlier 151-section set. They must be rerun on the final 148-section analysis set before the repository and manuscript are frozen. Do not relabel the 151-section run as a 148-section analysis.
